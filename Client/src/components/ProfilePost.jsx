...
const ProfilePost = () => {
    ...
    return (
        <div className='bg-bgColor h-full'>
            <div className=' bg-primary mx-72 rounded-lg '>
                <form onSubmit={handleSubmit(handlePosrSubmit)} className='bg-primary px-4 rounded-lg'>
                    ...
                    <div className='flex items-center justify-between py-4'>
                        ...
                        <div>{posting ? (
                            <Loading />
                        ) : (<CustomeButton type='submit' titile='post' containerStyle='bg-[#0444a4] text-white py-2 px-6 rounded-full font-semibold text-sm' />)}</div>
